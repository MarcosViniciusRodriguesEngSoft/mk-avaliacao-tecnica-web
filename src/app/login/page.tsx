    ...
    return (
        <div className="flex h-screen w-screen">
            <div className="flex justify-center items-center w-full h-full">
                <div className="flex flex-col bg-white p-6 rounded shadow-md w-full max-w-[400px] gap-8">
                    <LogoMiniature />
                    <h1 className="font-poppins text-[24px] font-bold leading-10">{t('login_screen.form.title')}</h1>
                    <h3 className="font-poppins text-[16px] font-normal leading-6">{t('login_screen.form.subTitle')}</h3>
